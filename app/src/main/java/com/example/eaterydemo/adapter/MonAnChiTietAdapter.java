...
import com.example.eaterydemo.fragments.MonAnChiTietFMDirections;
...
public class MonAnChiTietAdapter extends RecyclerView.Adapter<MonAnChiTietAdapter.ViewHolder> {
    ...
    public MonAnChiTietAdapter(List<MonAn> arr, Context context) {
        this.arr = arr;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        MonAnChiTietAdapter.ViewHolder viewHolder = new MonAnChiTietAdapter.ViewHolder(view);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NavDirections action = MonAnChiTietFMDirections.actionMonAnChiTietFMSelf(maNH, maMA);
